/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e9b4e173ade2a53c68b3e92d898861dc)
// Runtime types generated with workerd@1.20260903.1 2026-09-03 nodejs_compat
interface __BaseEnv_Env {
	MEDIA: R2Bucket;
	PUBLIC_MEDIA_BASE_URL: "PENDIENTE-VER-SETUP-R2.md";
	PUBLIC_SITE_URL: "PENDIENTE-VER-SETUP-DESPLIEGUE.md";
	PUBLIC_KEYSTATIC_GITHUB_APP_SLUG: "PENDIENTE-VER-SETUP-DESPLIEGUE.md";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_MEDIA_BASE_URL" | "PUBLIC_SITE_URL" | "PUBLIC_KEYSTATIC_GITHUB_APP_SLUG">> {}
}
